    ...
    return (
        <Grid container spacing={6}>
                            ...
                            <Table>
                                ...
                                >
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <CustomChip rounded size='small' skin='light' color='warning'
                                                        label='25PEROFF'/>
                                        </TableCell>
                                    </TableRow>
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <Typography sx={{color: 'text.secondary'}}>Black friday sale, 25%
                                                OFF</Typography>
                                        </TableCell>
                                    </TableRow>
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <Typography sx={{color: 'text.secondary'}}>2021-07-14 to
                                                2021-07-30</Typography>
                                        </TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
            ...
            >
                ...
                >
                    <img height={230} alt='review-illustration'
                         src='public/images/pages/create-deal-review-complete.png'/>
                </Box>
            </Grid>
        </Grid>
    )
