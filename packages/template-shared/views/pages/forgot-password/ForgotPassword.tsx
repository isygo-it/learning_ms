...
const ForgotPasswordView = () => {
    ...
    async function sendForgetPWDRequest(data: ResetPaswordRequest): Promise<AccountsTypes> {
        const response = await fetch(apiUrls.apiUrl_IMS_PasswordForgottenEndpoint, {
            method: 'POST',
