        ...
        <Card>
            ...
            <CardContent>
                <Grid container spacing={6}>
                    ...
                    <DemoGrid item xs={12} sm={10}>
                        <Typography sx={{mb: 2}}>Cupcake ipsum dolor sit amet chocolate bar pastry sesame
                            snaps.</Typography>
                    ...
                    <DemoGrid item xs={12} sm={10}>
                        <Typography variant='caption'>Cupcake ipsum dolor sit amet chocolate bar pastry sesame
                            snaps.</Typography>
                        <Typography variant='body2' sx={{mt: 2}}>
                    ...
                    <DemoGrid item xs={12} sm={10}>
                        <Typography variant='overline'>Cupcake ipsum dolor sit amet chocolate bar pastry sesame
                            snaps.</Typography>
