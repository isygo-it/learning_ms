...
import {updateThemeByCode} from "../../api/theme";
...
const Customizer = () => {
    ...
    //     const fetchedAccountData = await fetchOneAccount(storedUserData.id);
    //     setAccountDomainCode({accountCode: fetchedAccountData.code, domainCode: fetchedAccountData.domain});
    //
    ...
    //     ['theme', accountDomainCode],
    //     () => findThemeByCode(accountDomainCode),
    //     {
    //         enabled: !!accountDomainCode.accountCode && !!accountDomainCode.domainCode,
    //         onSuccess: (res: Theme) => {
    //             console.log(res)
    //             if (res != null) {
    //                 saveSettings({
    ...
    //                     mode: themeRecord[res?.mode]  as typeof mode,
    ...
    //                     appBarBlur: res?.appBarBlur,
    //                     navCollapsed: res?.navCollapsed,
    //                 });
    //             }
    //         },
    //     }
    ...
    const updateThemeMutation = useMutation({
        mutationFn: (accountDomainCode: AccountDomainCode) => updateThemeByCode({
